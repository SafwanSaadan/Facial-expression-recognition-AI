...
class GUI:
    def __init__(self, root):
        ...
        self.camera_frame = tk.Label(root, bg="#3498db", width=680, height=500)
        self.camera_frame.pack(pady=0)

        # إنشاء مكان لعرض النص
        self.class_label = tk.Label(root, text="", font=("Helvetica", 18, "bold"), bg="#3498db", fg="white", wraplength=680)
    ...
    def load_image(self):
        ...
        if file_path:
            ...
            temp_image = temp_image.resize((680, 500), Image.BICUBIC)
    ...
    def capture_image(self):
        ...
        image = cv2.resize(image, (680, 500), interpolation=cv2.INTER_AREA)
    ...
    def update_camera(self):
        while True:
            if self.camera_running:
                ...
                image = image.resize((680, 500), Image.BICUBIC)
